...
- Ein Beispiel für ein *Expanatory model* ist die Klassifikation von Bildern
...
Wir gehen von einem Modell für Körpergrößen aus. 
Dieses mal spielt auch die geographische Region (*region*) eine Rolle.
