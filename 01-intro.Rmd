...
Try to verify the simulation of probability in the [addendum](#addendum) below.
...
- How do you get the correlation matrix from the covariance matrix ($\Sigma$)?
  ...
  \end{bmatrix}
  $$
  Hint: For the bivariate normal distribution, the correlation matrix is defined [here](https://en.wikipedia.org/wiki/Multivariate_normal_distribution#Bivariate_case).
