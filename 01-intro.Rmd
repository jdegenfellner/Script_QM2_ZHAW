...
On average, the deviations are zero and the **errors should also be are independent from each other**:
...
- 'Residual standard error': The standard deviation of the residuals. In this case identical with the standard error 
    of heights. $351$ degrees of freedom. There are $352$ observations and 
