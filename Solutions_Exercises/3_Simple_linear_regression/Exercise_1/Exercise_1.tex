...
$\mu_i = \alpha$,\\
\\
which can be interpreted as expected height of a person who has average weight.\\
\\
2) If $x_i$ increases by one unit, the weight is $1kg$ above the average weight (assuming it was average before),
