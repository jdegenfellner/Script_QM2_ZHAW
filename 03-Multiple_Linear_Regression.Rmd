...
In the example below, the second prector $X_2$ is a *perfect* linear 
...
# -> meanlog shuold be around 5!, not 140!
...
in exptected values of the log-normal distribution.
...
- Verify that that both adjustment sets   $\{A, M\} \text{ and } \{S\}$ 
...
- Read [this paper](https://www.sciencedirect.com/science/article/pii/S1836955314000083) 
  ...
  - Try to critisize the paper with respect to the content we have covered so far.
