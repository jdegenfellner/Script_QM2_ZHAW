...
scientist estimating regression models know about this.
...
We will look at these 3 examples below - the **pipe, the fork, the collider**. These are causal graphs showing the 
...
*acyclic* because there are no cycles in the graph.

#### Pipe
In this setting $X$ is associated with $Z$ and $Z$ is associated with $Y$. $X$ and $Y$ are also associated.
