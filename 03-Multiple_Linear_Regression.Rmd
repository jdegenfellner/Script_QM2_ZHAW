...
We will look at these 3 examples below - **the pipe, the fork and the collider**. These are causal graphs showing the 
...
for the definition of $Z$. As you can see, $Z$ is defined as a **sum 
...
This is also called [Berkson's paradox](https://en.wikipedia.org/wiki/Berkson%27s_paradox).
