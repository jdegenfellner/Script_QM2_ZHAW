...
- Pipe: In this setting $X$ is associated with $Y$ and $Z$ is associated with $Y$. $X$ and $Y$ are also associated.
...
- Verify that the coefficient for $X$ disappears when you add $Z$ to the model for the pipe and collider as well.
