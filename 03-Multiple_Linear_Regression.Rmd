...
### Simpsons Paradox and what happens when you just throw variables into multiple regression {#simpsons_paradox}
...
- Model the quadratic/cubic relationship between weight and height using a line
  and show residuals.
