...
Let's visualize this with our regression result:
...
ggplot(d2, aes(x = weight, y = height)) +
  ...
  geom_point(data = highlight_point, aes(x = weight, y = height), color = "red", size = 3) +
  ...
  geom_segment(data = highlight_point,
               aes(x = weight, xend = weight, 
                   y = height, yend = predicted_height, color = "Point-to-Line"), 
               linetype = "dashed") +
  
  # Vertical difference: Regression line and mean height (offset slightly right)
  geom_segment(data = highlight_point,
               aes(x = weight + 0.5, xend = weight + 0.5, 
                   y = predicted_height, yend = mean_height, color = "Line-to-Mean"), 
               linetype = "dashed") +
  
  # Add horizontal line for the mean height
  geom_hline(yintercept = mean(d2$height), color = "darkgreen", linetype = "dashed") +
