...
In this case, everything loosk fine. Let's go through the plots and explain them:
...
The simulated and original data fit nicely together. 
This lends some credibility to the model.
And now the density plots of the model created data and the observed data:
...
Depending on the context, this might be a problem or not. Let's accept this model for now.
...
- One could think of the least squares method of minimizing the sum of 
  ...
  - confint regression coefficients
