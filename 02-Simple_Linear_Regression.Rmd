...
It describes the phenomenon that the predicted value (y) is closer to the mean than the predictor (x).
In our case this, if the weight of a person is 1 standard deviation above the mean of body weights,
...
As Gelman points out in his book (Fiugure 4.2), there is a fine detail:
