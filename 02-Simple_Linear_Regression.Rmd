...
A non-obvious and very useful finding is that the total variability 
...
You would just get a value for each data point by setting all other $\beta_i$ to zero. 
...
### [H] Exercise 8 {#exercise8_simpl_lin_reg}
