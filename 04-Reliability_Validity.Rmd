...
Since we have two raters (Peter and Mary), we consider the fact that they could have a systematic difference,
i.e., a bias. For example in the book, Mary has a 5 degree bias. 
At the moment, there is no systematic difference between Peter and Mary added to the data. 

TODO...
https://discourse.mc-stan.org/t/extending-the-interclass-correlation-coefficient-icc-aka-repeatability-aka-heritability-for-bayesian-models/27793
\begin{eqnarray*}
Y_i \sim N(\mu_i, \sigma_{\varepsilon})\\
\mu_i &=& beta_1[ID]\\
\beta_0 &\sim& \text{Normal}(0, 20)\\
\beta_1 &\sim& \text{Normal}(0, 10)\\
\sigma_{\varepsilon} &\sim& \text{Uniform}(0, 30)
\end{eqnarray*}
