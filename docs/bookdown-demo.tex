...
\begin{verbatim}
##             mean        sd       5.5%      94.5%
## mu    154.604095 0.4119943 153.945648 155.262541
## sigma   7.731333 0.2913859   7.265642   8.197024
\end{verbatim}
...
\begin{verbatim}
##                 mu        sigma
## mu    0.1697392671 0.0001537322
## sigma 0.0001537322 0.0849057475
\end{verbatim}
...
\begin{verbatim}
##                mu       sigma
## mu    1.000000000 0.001280575
## sigma 0.001280575 1.000000000
\end{verbatim}
...
\begin{verbatim}
## file:////private/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpzQ6tan/file177ff5ec1c6ff/widget177ff3efbff3.html screenshot completed
\end{verbatim}
...
\begin{verbatim}
## file:////private/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpzQ6tan/file177ff9b76c4/widget177ff5e923e2b.html screenshot completed
\end{verbatim}
...
\begin{verbatim}
## file:////private/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpzQ6tan/file177ff579c08f7/widget177ff4510bd10.html screenshot completed
\end{verbatim}
...
\begin{verbatim}
## file:////private/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpzQ6tan/file177ff4b73fa3d/widget177ff2b31e17e.html screenshot completed
\end{verbatim}
...
\begin{verbatim}
## file:////private/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpzQ6tan/file177ff41f24a29/widget177ff9e2eb92.html screenshot completed
\end{verbatim}
...
\begin{verbatim}
## Chain 1 Exception: normal_lpdf: Scale parameter is 0, but must be positive! (in '/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpzQ6tan/model-177ff7b56f8cf.stan', line 17, column 4 to column 34)
\end{verbatim}
...
\begin{verbatim}
## Chain 2 Exception: normal_lpdf: Scale parameter is 0, but must be positive! (in '/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpzQ6tan/model-177ff7b56f8cf.stan', line 17, column 4 to column 34)
\end{verbatim}
...
\begin{verbatim}
## Chain 4 Exception: normal_lpdf: Scale parameter is 0, but must be positive! (in '/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpzQ6tan/model-177ff7b56f8cf.stan', line 17, column 4 to column 34)
\end{verbatim}
...
\begin{verbatim}
## Chain 5 Exception: normal_lpdf: Scale parameter is 0, but must be positive! (in '/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpzQ6tan/model-177ff7b56f8cf.stan', line 17, column 4 to column 34)
\end{verbatim}
...
\begin{verbatim}
## Chain 6 Exception: normal_lpdf: Scale parameter is 0, but must be positive! (in '/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpzQ6tan/model-177ff7b56f8cf.stan', line 17, column 4 to column 34)
\end{verbatim}
...
\begin{verbatim}
## Chain 1 Exception: normal_lpdf: Scale parameter is 0, but must be positive! (in '/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpzQ6tan/model-177ffc9d05c2.stan', line 21, column 4 to column 45)
\end{verbatim}
...
\begin{verbatim}
## Chain 2 Exception: normal_lpdf: Scale parameter is 0, but must be positive! (in '/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpzQ6tan/model-177ffc9d05c2.stan', line 21, column 4 to column 45)
\end{verbatim}
...
\begin{verbatim}
## Chain 4 Exception: normal_lpdf: Scale parameter is 0, but must be positive! (in '/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpzQ6tan/model-177ffc9d05c2.stan', line 21, column 4 to column 45)
\end{verbatim}
...
\begin{verbatim}
## Chain 5 Exception: normal_lpdf: Scale parameter is 0, but must be positive! (in '/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpzQ6tan/model-177ffc9d05c2.stan', line 21, column 4 to column 45)
\end{verbatim}
...
\begin{verbatim}
## Chain 7 Exception: normal_lpdf: Scale parameter is 0, but must be positive! (in '/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmpzQ6tan/model-177ffc9d05c2.stan', line 21, column 4 to column 45)
\end{verbatim}
...
\item
  ...
  judge and the judges are selected at random.''
  This is formally not our situation, since we have only two raters and
  50 patients. But for this case, we do not care how measures, since we do not
  model it, hence, we cannot know if there are systematic differences between
  the raters. This is the ICC we calculated above.
  This ICC is called \(ICC_{consistency}\) in the book and based on the following
  model:

  \[ Y_ij = \eta_j + \varepsilon_i \]
...
\item
  ...
  ICC2 and ICC3 are based on the \emph{same} statistical model. The only difference is
  that ICC2 assumes that the raters are randomly selected from a larger pool of raters,
  hence, the rater variability must be explicitely considered and yields a potentially smaller
  value for the ICC. The model is:

  \[ Y_ij = \eta_j + \beta_j + \varepsilon_i \]
  where \(j \in {1,...,50}\) is the patient, \(j \in {1,2}\) is the \textbf{rater}
  (doing one measurement each). The ICC is then calculated as:
...
\item
  ...
  This means that the raters are the same for all patients.
  ...
  measurements, not other therapists. The ICC is then calculated as:
